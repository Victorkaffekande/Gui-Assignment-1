...
public class StudentViewController2 implements Initializable {
    ...
    public TableColumn TCkl;
    public TableColumn TCLessons;
    public TableColumn TCStatus;
    public Button handleTilStedeBTN;
    public Button handleIkkeTilstedeBTN;
    public PieChart pieChart;
    public Label pieLabel;
    public VBox pieVBox;
    private TimeHelper timeHelper;

    public StudentViewController2() {
